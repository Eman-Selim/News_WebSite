...
namespace FirstCoreApp.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Topic,Date,Image,CategoryId")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Topic,Date,Image,CategoryId")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
